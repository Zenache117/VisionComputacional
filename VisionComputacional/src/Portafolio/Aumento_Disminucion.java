	...
	public static void main(String[] args) {
		...
		String rutaImagen = archivoSeleccionado.selectFile();
			  ...
			  //Pedir valor a disminu�r y aumentar
			    ...
			    {
			    	valorDisminucionBrillo = Integer.parseInt(JOptionPane.showInputDialog("Dame el valor a disminuir de brillo"));
			    ...
			    //Definir variables para resguardar el valor maximo y minimo alcanzado por los pixeles en sus modificaciones
			    ...
			    for (int i = 0; i < imageGray.rows(); i++) {
			        for (int j = 0; j < imageGray.cols(); j++) {
			         ...
			         // Disminuci�n de brillo
			            double[] pixelDisminucionBrillo = new double[] {
			                pixelOriginal[0] - valorDisminucionBrillo
			            };
			            ...
			            // Aumento de brillo
			            double[] pixelAumentoBrillo = new double[] {
			                pixelOriginal[0] + valorAumentoBrillo
			            };
			 ...
			 // Reajustar los pixeles de imagenAumentoBrillo
			    ...
			    if (minValue < 0) {
			    	respuestaDisminuir = JOptionPane.showConfirmDialog(null, "�Quieres reajustar la imagen a disminuir brillo?", "Reajustar", JOptionPane.YES_NO_CANCEL_OPTION);
